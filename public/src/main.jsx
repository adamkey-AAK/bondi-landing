...
function BondiLogo() {
  return (
    <motion.img
      ...
      animate={{ opacity: 1; transition: all 0.4s ease-in-out, y: 0 }}
    ...
    <div className="bg">
      ...
      <svg className="bg-lines" viewBox="0 0 100 100" preserveAspectRatio="none">
        <motion.path
          ...
          animate={{ pathLength: 1, opacity: 1; transition: all 0.4s ease-in-out }}
            ...
            <div className="copy">
              ...
              <h1>
                ...
                <motion.span
                  ...
                  animate={{ opacity: 1; transition: all 0.4s ease-in-out, filter: "blur(0px)", y: 0 }}
