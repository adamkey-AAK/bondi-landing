  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{
          filter: [
            "drop-shadow(0 0 14px rgba(112,145,109,0.16))",
            "drop-shadow(0 0 26px rgba(112,145,109,0.28))",
            "drop-shadow(0 0 14px rgba(112,145,109,0.16))",
          ],
        }}
        transition={{ duration: 4.8, repeat: Infinity, ease: "easeInOut" }}
      >
        <span className="logo-leaf logo-left" />
        <span className="logo-leaf logo-right" />
      </motion.div>
